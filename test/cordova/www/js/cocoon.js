/**
 * @fileOverview
 <p>Atomic Plugins provide an elegant and minimalist API and are designed with portability in mind from the beginning. Framework dependencies are avoided by design so the plugins can run on any platform and can be integrated with any app framework or game engine.</p>

<p>This repo contains an in-app purchase API designed using the Atomic Plugins paradigm. You can integrate IAPs in your app and take advantage of all the features provided: elegant API, local and server-side receipt validation, secure consumable and non-consumable purchase tracking, local products cache, etc. The API is alreadt available in many languagues and we have the plan to add more in the future:</p>
<ul>
<li>Objective-C API for pure iOS/Mac apps.</li>
<li>Java API for pure Android apps.</li>
<li>JavaScript API for Cordova or Cocoon based Apps.</li>
<li>C++ API for C++ based apps and games.</li>
</ul>
